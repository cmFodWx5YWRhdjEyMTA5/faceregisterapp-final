...
public class CameraSourcePreviewOld extends ViewGroup
{
    ...
    private GraphicOverlayOld mOverlay;
    private int screenWidth;
    private int screenHeight;
    private int screenRotation;

    public CameraSourcePreviewOld(Context context)
    {
        super(context);
    ...
    public CameraSourcePreviewOld(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public void start(Camera2Source camera2Source, GraphicOverlayOld overlay) throws IOException
    {
        mOverlay = overlay;
        start(camera2Source);
    }
